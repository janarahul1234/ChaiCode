        ...
        <div className="max-[300px]:mx-4 mx-6 mt-16 mb-8 sm:mb-5 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col sm:flex-row sm:justify-center gap-4">
            <a
              ...
              className="sm:w-[218px] bg-white text-neutral-950 py-3.5 flex justify-center items-center gap-4 rounded-lg transition duration-300 ease-in-out hover:scale-105"
            >
              <i class="ri-download-2-line text-4xl relative z-1"></i>
              <div className="flex flex-col relative z-1">
                <span className="text-sm opacity-65">Dowload on the</span>
            ...
            <a
              ...
              className="sm:w-[218px] bg-white text-neutral-950 py-3.5 flex justify-center items-center gap-4 rounded-lg transition duration-300 ease-in-out hover:scale-105"
            >
              <i class="ri-download-2-line text-4xl"></i>
              <div className="flex flex-col">
                <span className="text-sm opacity-65">Get it on</span>
